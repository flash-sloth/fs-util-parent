 ...
 */
public interface TreeController<Id extends Serializable, Entity, QueryVO, ResultVO extends TreeNode<Id>>
    ...
    @PostMapping("/tree")
    @WebLog("按树结构查询")
    default R<List<Tree<Id>>> tree(@RequestBody QueryVO pageQuery) {
        ...
        List<ResultVO> treeList = BeanUtil.copyToList(list, getResultVoClass());
