package top.fsfsfs.basic.log.aspect;
...
import top.fsfsfs.basic.log.event.SysLogEvent;
import top.fsfsfs.basic.log.util.LogUtil;
import top.fsfsfs.basic.log.util.ThreadLocalParam;
...
public class SysLogAspect {
     ...
     *
     * execution(public * top.fsfsfs.basic.base.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第二个* top.fsfsfs.basic.base.controller包下的所有类
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     *
     * \@annotation(top.fsfsfs.basic.annotation.log.WebLog) 解释：
     * 标记了@WebLog 注解的方法
     */
    @Pointcut("execution(public * top.fsfsfs.basic.base.controller.*.*(..)) || @annotation(top.fsfsfs.basic.annotation.log.WebLog)")
