 ...
 * the License.
 */
package top.fsfsfs.basic.mybatisplus.mybatis.conditions.query;
...
import top.fsfsfs.basic.db.typehandler.SqlUtils;
...
import static top.fsfsfs.basic.mybatisplus.mybatis.conditions.Wraps.replace;
...
public class LbQueryWrap<T> extends AbstractLambdaWrapper<T, LbQueryWrap<T>>
    ...
    public LbQueryWrap<T> like(SFunction<T, ?> column, Object val) {
        return super.like(this.checkCondition(val), column, SqlUtils.keywordConvert(val));
    }

    @Override
    public LbQueryWrap<T> likeLeft(SFunction<T, ?> column, Object val) {
        return super.likeLeft(this.checkCondition(val), column, SqlUtils.keywordConvert(val));
    }

    @Override
    public LbQueryWrap<T> likeRight(SFunction<T, ?> column, Object val) {
        return super.likeRight(this.checkCondition(val), column, SqlUtils.keywordConvert(val));
    }
    ...
    public LbQueryWrap<T> notLike(SFunction<T, ?> column, Object val) {
        return super.notLike(this.checkCondition(val), column, SqlUtils.keywordConvert(val));
    }
