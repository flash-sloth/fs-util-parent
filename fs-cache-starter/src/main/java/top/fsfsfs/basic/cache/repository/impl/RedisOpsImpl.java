package top.fsfsfs.basic.cache.repository.impl;
...
import top.fsfsfs.basic.cache.redis.BaseRedis;
...
public class RedisOpsImpl extends BaseRedis {
    ...
    @Override
    public <HV> List<CacheResult<HV>> hVals(CacheHashKey key) {
        return hVals(key.getKey());
    }
