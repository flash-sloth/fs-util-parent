...
import static top.fsfsfs.util.utils.DateUtils.DEFAULT_DATE_FORMAT;
import static top.fsfsfs.util.utils.DateUtils.DEFAULT_DATE_FORMAT_EN;
import static top.fsfsfs.util.utils.DateUtils.DEFAULT_DATE_FORMAT_EN_MATCHES;
import static top.fsfsfs.util.utils.DateUtils.DEFAULT_DATE_FORMAT_MATCHES;
import static top.fsfsfs.util.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT;
import static top.fsfsfs.util.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_EN;
import static top.fsfsfs.util.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_EN_MATCHES;
import static top.fsfsfs.util.utils.DateUtils.DEFAULT_DATE_TIME_FORMAT_MATCHES;
import static top.fsfsfs.util.utils.DateUtils.SLASH_DATE_FORMAT;
import static top.fsfsfs.util.utils.DateUtils.SLASH_DATE_FORMAT_MATCHES;
import static top.fsfsfs.util.utils.DateUtils.SLASH_DATE_TIME_FORMAT;
import static top.fsfsfs.util.utils.DateUtils.SLASH_DATE_TIME_FORMAT_MATCHES;
...
public class FsLocalDateTimeDeserializer extends JSR310DateTimeDeserializerBase<LocalDateTime> {
    public static final FsLocalDateTimeDeserializer INSTANCE = new FsLocalDateTimeDeserializer();
    ...
    private FsLocalDateTimeDeserializer() {
        this(DEFAULT_FORMATTER);
    }

    public FsLocalDateTimeDeserializer(DateTimeFormatter formatter) {
        super(LocalDateTime.class, formatter);
    }

    protected FsLocalDateTimeDeserializer(FsLocalDateTimeDeserializer base, Boolean leniency) {
        super(base, leniency);
    }
    ...
    @Override
    protected FsLocalDateTimeDeserializer withLeniency(Boolean leniency) {
        return new FsLocalDateTimeDeserializer(this, leniency);
    }
