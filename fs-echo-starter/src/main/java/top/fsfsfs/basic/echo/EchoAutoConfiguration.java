...
import top.fsfsfs.basic.echo.aspect.EchoResultAspect;
import top.fsfsfs.basic.echo.core.EchoServiceImpl;
...
public class EchoAutoConfiguration {
     ...
     * @return top.fsfsfs.basic.echo.core.EchoService
     * @author tangyh
     * @since 2021/8/15 10:17 下午
