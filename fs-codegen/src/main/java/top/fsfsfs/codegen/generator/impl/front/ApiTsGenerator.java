...
public class ApiTsGenerator implements IGenerator {

    private GenTypeEnum genType;

    public ApiTsGenerator() {
        this(GenTypeEnum.API_TS);
    }

    public ApiTsGenerator(GenTypeEnum genType) {
