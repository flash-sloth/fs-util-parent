...
public class IndexVueGenerator implements IGenerator {

    private GenTypeEnum genType;

    public IndexVueGenerator() {
        this(GenTypeEnum.INDEX_VUE);
    }

    public IndexVueGenerator(GenTypeEnum genType) {
