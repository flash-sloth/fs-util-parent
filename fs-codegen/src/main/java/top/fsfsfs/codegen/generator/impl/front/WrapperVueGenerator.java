...
public class WrapperVueGenerator implements IGenerator {

    private GenTypeEnum genType;

    public WrapperVueGenerator() {
        this(GenTypeEnum.WRAPPER_VUE);
    }

    public WrapperVueGenerator(GenTypeEnum genType) {
