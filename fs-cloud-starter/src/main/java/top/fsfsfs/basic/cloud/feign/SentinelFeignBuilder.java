package top.fsfsfs.basic.cloud.feign;
        ...
        super.invocationHandlerFactory(new InvocationHandlerFactory() {
            ...
            public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
                ...
                if (void.class != fallback) {
                    ...
                    return new FsSentinelInvocationHandler(target, dispatch, new FallbackFactory.Default<>(fallbackInstance));
                }
                if (void.class != fallbackFactory) {
                    ...
                    return new FsSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
                }
                return new FsSentinelInvocationHandler(target, dispatch);
            }
