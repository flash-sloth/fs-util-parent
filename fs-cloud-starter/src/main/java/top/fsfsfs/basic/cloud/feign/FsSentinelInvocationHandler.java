 ...
 */
@Slf4j
public class FsSentinelInvocationHandler implements InvocationHandler {
    ...
    FsSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof FsSentinelInvocationHandler other) {
