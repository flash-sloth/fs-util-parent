package top.fsfsfs.basic.jwt.properties;
...
import static top.fsfsfs.basic.jwt.properties.JwtProperties.PREFIX;
...
public class JwtProperties {
     ...
     * 使用场景2：？
     * <p>
     * 在 fs-gateway-server.yml 配置即可
     */
    private Long allowedClockSkewSeconds = 60L;
    /**
     * jwt 签名，长度至少32位。
     * 建议每个公司都修改一下这个字符串！
     * 必须在 fs-oauth-server.yml 和 fs-gateway-server.yml 中同时配置，且配置值必须一致
     */
